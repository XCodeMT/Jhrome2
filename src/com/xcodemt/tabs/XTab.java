...
/**
 * The default implementation of {@link ITab}. Contains a title label and close button. The label can be replaced with any {@link Component}, and the jhromeTab's look and feel can be customized with
 * {@link XTabUI}.
 *
 * @author andy.edwards
 */
@SuppressWarnings( "serial")
public class XTab extends JComponent implements ITab {

    private static final String uiClassId = XTabUI.class.getName();
    ...
    public XTab(String title) {
        this(title, null);
    }

    public XTab(String title, Component content) {
    ...
    public boolean isDraggableAt(Point p) {
        if (ui != null && ui instanceof XTabUI) {
            XTabUI jui = (XTabUI) ui;
    ...
    public void updateUI() {
        setUI((XTabUI) UIManager.getUI(this));
    }

    public void setUI(XTabUI ui) {
        super.setUI(ui);
    }
}
