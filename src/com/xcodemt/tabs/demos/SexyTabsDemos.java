    ...
    public void start() {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                final XTabbedPaneWindowFactory windowFactory = new XTabbedPaneWindowFactory();
                windowFactory.showNewTabButton = false;
                final ITabbedPaneWindow window = windowFactory.createWindow();

                final XTab demoSelectorTab = new XTab("SexyTabs Demos", demoListPanel);
                ...
                demoList.addListSelectionListener(new ListSelectionListener() {
                    ...
                    public void valueChanged(ListSelectionEvent e) {
                        if (!e.getValueIsAdjusting() && demoList.getSelectedValue() != null && demoList.getSelectedValue() instanceof DemoItem) {
                            ...
                            if (tabbedPane != null) {
                                XTab demoTab = new XTab(demoItem.name, createDemoPanel(demoItem.demo, demoItem.source));
