...
import com.xcodemt.tabs.XTabUI;

/**
 * The UI for a {@link XTab}.
 *
 * @author andy.edwards
 */
public class JhromeTabUI extends XTabUI {
    ...
    protected void update(XTab defaultTab) {
     ...
     */
    @Override
    public boolean isDraggableAt(XTab defaultTab, Point p) {
     ...
     */
    @Override
    public boolean isSelectableAt(XTab defaultTab, Point p) {
     ...
     */
    @Override
    public boolean isHoverableAt(XTab defaultTab, Point p) {
